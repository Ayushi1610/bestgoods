...
export default function ListItems(props){
  ...
  <div>
    ...
    <ListItem button>
      ...
      <ListItemText primary="Products" onClick={()=>handleClick(<DisplayAllProduct setComponent={props.setComponent}/>)} />
    </ListItem>
    <ListItem button>
      <ListItemIcon>
        <LayersIcon />
    ...
    <ListItem button>
      ...
      <ListItemText primary="Add Banners" onClick={()=>handleClick(<DisplayAllBanners setComponent={props.setComponent}/>)}/>
    </ListItem>
    <ListItem button>
      <ListItemIcon>
        <LayersIcon />
      </ListItemIcon>
      <ListItemText primary="Edit/Delete Final Pictures" onClick={()=>handleClick(<DisplayMorePictures setComponent={props.setComponent}/>)}/>
    </ListItem>
  </div>
  <Divider/>
  <div>
