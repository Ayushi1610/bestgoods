           ...
           <div className={classes.subdiv}>
             ...
             <Grid item xs={12}>
               ...
               <div style={{display:'flex',flexDirection:'row'}}>
                 ...
                 <div>
                   <Button onClick={()=>handleClick()} variant="contained" startIcon={<List/>}>Company List</Button>
                  </div>
                  </Grid>
               </Grid>
              </Grid>
                <Grid item xs={12}>
                  <TextField onChange={(event)=>setCompany(event.target.value)} fullWidth variant="outlined" label="Company Name"/>
                </Grid>
                <Grid item xs={4}>
                  <TextField onChange={(event)=>setContactPerson(event.target.value)} fullWidth variant="outlined" label="Contact Person"/>
                </Grid>
                <Grid item xs={4}>
                  <TextField onChange={(event)=>setContactNumber(event.target.value)} fullWidth variant="outlined" label="Contact Number"/>
                </Grid>
                <Grid item xs={4}>
                  <TextField onChange={(event)=>setEmail(event.target.value)} fullWidth variant="outlined" label="Company Email Id"/>
                </Grid>
                <Grid item xs={12}>
