  ...
  export default function DisplayAllModels(props){
    ...
    const handleCompanyChange=(event)=>{
      ...
      const handleSubmit=async()=>{
        setOpen(false)
        var body={categoryId:categoryid,subcategoryId:subcategoryid,companyId:companyid,productId:productid,modelName:modelname,size:size,weight:weight,modelId:modelid}
       ...
       <div className={classes.subdiv}>
         ...
         <Grid item xs={12}>
           ...
           <div style={{display:'flex',flexDirection:'row'}}>
             ...
             <div>
               <Button onClick={()=>fetchAllModel()} variant="contained" startIcon={<List/>}>Models List</Button>
              </div>
              </Grid>
           </Grid>
          </Grid>
        ...
        >
          {fillCompany()}
            ...
            <Grid item xs={6}>
              <TextField value={size} onChange={(event)=>setSize(event.target.value)} fullWidth variant="outlined" label="Size"/>
            </Grid>
            <Grid item xs={6}>
              <TextField value={weight} onChange={(event)=>setWeight(event.target.value)} fullWidth variant="outlined" label="Weight"/>
            </Grid>
                    <Grid item xs={6} >
          ...
          title={
            ...
            <div style={{display:'flex',flexDirection:'row',width:4500,alignItems:'flex-start'}}>
              <div style={{padding:5}}>
                ...
                <div style={{marginLeft:300,fontSize:20,fontWeight:700,letterSpacing:1,padding:5}}>List of Models</div>
              </div>}
          columns={[
